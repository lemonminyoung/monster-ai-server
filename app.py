...
PERSONAS = {
    1: {
        ...
        "sentiment_guidance": "당신은 부정적이거나 중립적인 감정을 60% 정도 표현하는 경향이 있습니다. 특히, -2, -1, 0 점수를 비교적 균등하게 부여하고, +1과 +2 점수는 비교적 적게 부여하세요. 당신을 무시하거나 약하게 볼 경우 -2를, 도전하거나 거슬리게 할 경우 -1을 부여하는 경향이 있습니다. 당신의 힘을 인정하거나 칭찬할 경우, +1 또는 +2를 부여합니다."
    },
    2: {
        "name": "나이트쉐이드",
